...
Mesa de Partes
  ...
  <div class="card">
    ...
    <p style="font-size:20px;font-weight:bold" class="login-box-msg">Inicio como Usuario</p>
      <div class="btn-group btn-block">
      <a href="index_usuario.php" class="btn btn-primary ">USUARIO</a>
        <a href="index.php" class="btn btn-primary ">ADMINISTRADOR</a>
      </div>
      <hr>
      <form action="app/controllers/login/controller-login-usuario.php" method="post">
      ...
      <div class="row">
        ...
        <div class="row">
        <div class="col-12">
          <a href="<?=APP_URL;?>/login/1recuperar_contrasena.php" class="btn btn-link">Olvidé mi contraseña</a>
        </div>
      </div>
      </div>
      <?php
