...
Mesa de Partes
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <hr>
      <form action="app/controllers/login/register.php" method="POST">
        
      <label for="confirm_password">Ingresa tu Correo Electrónico</label>
        <div class="input-group mb-3">
            ...
            <label for="confirm_password">Ingresa tu Clave</label>
            <div class="input-group mb-3">
            ...
            <label for="confirm_password">Ingresa nuevamente tu Clave</label>
            <div class="input-group mb-3">
